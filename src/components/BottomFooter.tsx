  ...
  return (
    <footer id="app-bottom-navbar" className="w-full bg-[#1d1b19] text-[#e8e2d8] border-t border-[#33302a] mt-auto">
      ...
      <div className="border-b border-[#33302a] bg-[#171513] px-4 py-4">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-[12px]">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-[12px]">
        {/* Col 1: Brand & Contact */}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2.5 pt-1">
            <a
              ...
              aria-label="Facebook"
              className="w-9 h-9 rounded-lg bg-[#2b2724] hover:bg-[#ffc55f] hover:text-[#1d1b19] flex items-center justify-center transition-all cursor-pointer text-white"
            >
            ...
            <a
              ...
              className="w-9 h-9 rounded-lg bg-[#2b2724] hover:bg-[#25D366] hover:text-white flex items-center justify-center transition-all cursor-pointer text-white"
            >
